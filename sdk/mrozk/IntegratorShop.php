...
class IntegratorShop extends \DDelivery\Adapter\PluginFilters
{
    ...
    public function getApiKey(){
        if( isset($_REQUEST['ddcalc_from']) ){
            $ddcalc_from = (int)$_REQUEST['ddcalc_from'];
        }else{
            $ddcalc_from = 1;
        }
        ...
        switch( $ddcalc_from ){
            case 1:
                return '85754d2fab577fffe4f9fd5d8e71d91b';
            case 2:
                return '584ac2d4ef3daa60b297a820385e1c70';
            case 3:
                return '3955d6bde34b21e6a0f022d9ba619ab0';
            case 4:
                return '393c4f37b7ee99708a3f3fb2a1f5b2d8';
            case 5:
                return '3e4fee34913b6fdb1c1afb2f0b38d3cd';
            case 6:
                return 'e1c0f45078fc78435c44de8568afe071';
            case 7:
                return '62d844ab0a0ed2a17fe648767740a4de';
            case 8:
                return '056d810dd87abfbf68a13659c37bcc5a';
            case 9:
                return 'e113f2cacc1e9ffb78896b70aa7bd4ba';
            case 10:
                return '77b1a54d01a9e90a57cc4cebfe4810fc';
            default:
                return '85754d2fab577fffe4f9fd5d8e71d91b';
        }
    }
